...
class CSql():
    ...
    def omConnect(self, p_cDB = None):
        ...
        if p_cDB == 1:
            lcConnect = "host=localhost dbname=UCSMLISTEN user=postgres password=holiboli port=5432"
        else:
            lcConnect = "host=localhost dbname=GAMESTORE user=postgres password=holiboli port=5432"
        #print 'Conectando ...'
        try:
